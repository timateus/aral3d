        ...
        <>
          ...
          {!sandboxActive && (
            <>
              ...
              {showEnvironmentalIssues && <EnvironmentalIssuesLayer terrain={terrain} exaggeration={exaggeration} year={waterExtentYear} />}
